...
#         plt.show(block=False)
    ...
    def __getitem__(self, index):
        ...
        # SpecAug, not do for eval set #check if it is done on eval dataset
...
#             plot_mel_fbank(fbank)
        ...
        #if fbank.shape[0] != 700:
            #print(datum['wav'],datum['segment'])
           # return torch.rand(700, fbank.shape[1]), label_indicse 
