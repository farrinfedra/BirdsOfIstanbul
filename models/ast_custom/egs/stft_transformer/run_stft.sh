...
mixup=0
epoch=20
batch_size=8 #48 experiment with gpu memory 
fstride=10 
tstride=10
base_exp_dir=./exp/test-${dataset}-f$fstride-t$tstride-imp$imagenetpretrain-asp$audiosetpretrain-b$batch_size-lr${lr}-$epoch-stft
...
do
  ...
  tr_data=./datafiles/stft_datafiles/stft_train_data_${fold}.json
  te_data=./datafiles/stft_datafiles/stft_eval_data_${fold}.json
