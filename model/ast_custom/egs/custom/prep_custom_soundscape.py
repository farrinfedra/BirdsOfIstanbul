...
if os.path.exists('./data/datafiles_train_soundscape') == False:
    os.mkdir('./data/datafiles_train_soundscape')


#base_path = "/kuacc/users/bbiner21/ast/egs/custom/data/custom_data/soundscape_audio_16k/"
#base_for_norm = "/kuacc/users/bbiner21/ast/egs/custom/data/custom_data/soundscape_audio_16k/"

meta = np.loadtxt('./data/custom_data/train_soundscape_labels.csv', delimiter=',', dtype='str', skiprows=1)
train_wav_list = []
eval_wav_list = []
all_data = []
...
with open('./data/datafiles_train_soundscape/train_soundscape_nocall'+'.json', 'w') as f:
